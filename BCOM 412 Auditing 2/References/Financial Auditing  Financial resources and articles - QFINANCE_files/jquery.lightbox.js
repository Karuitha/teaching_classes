...
(function(jQuery) {
	...
	jQuery.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'/qf-theme/images/qfinance/loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'/qf-theme/images/qfinance/lightbox_prev.gif',	// (string) Path and the name of the prev button image
			imageBtnNext:			'/qf-theme/images/qfinance/lightbox_next.gif',	// (string) Path and the name of the next button image
			imageBtnClose:			'/qf-theme/images/qfinance/close.gif',			// (string) Path and the name of the close btn
			imageBlank:				'/qf-theme/images/qfinance/px.gif',				// (string) Path and the name of a blank image (one pixel)
		...
		function _set_interface() {
			...
			jQuery('body').append('<div id="jquery-overlay"></div><div id="jquery-lightbox"><div id="lightbox-container-image-data-box"><div id="lightbox-container-image-data"><div id="lightbox-image-details"><span id="lightbox-image-details-caption"></span><span id="lightbox-image-details-currentNumber"></span></div><div id="lightbox-secNav"><a href="#" id="lightbox-secNav-btnClose"><img src="' + settings.imageBtnClose + '"></a></div></div></div><div id="lightbox-container-image-box"><div id="lightbox-container-image"><img id="lightbox-image"><div style="" id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"></a><a href="#" id="lightbox-nav-btnNext"></a></div><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="' + settings.imageLoading + '"></a></div></div></div></div>');	
			// Get page sizes
		...
		function _show_image() {
			...
			jQuery('#lightbox-image').fadeIn(function() {
				_show_image_data();
				//_set_navigation();  /* Removed for the QFinance site*/
			});
			//_preload_neighbor_images();  /* Removed for the QFinance site*/
		};
		/**
