...
subtitle: 'Course Outline: BBM 419- Financial Statements Analysis'
...
2. Getting comfortable with Ms Excel for Financial Analysis (Week 1 to 4).
2. Financial statements.
3. Using Financial Statement Information; why evaluate financial statements? Internal uses, external uses, choosing a benchmark, problems with financial statements analysis.
