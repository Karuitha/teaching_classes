...
\center
\textbf{SUPPEMENTARY/ SPECIAL EXAMINATIONS}
...
The total cost function for a product is c(x) = 60x + 1200, and the total revenue is R(x) = 72x, where x is the number of units produced and sold.
...
a) Define the following terms, citing examples (i) Column matrix, (ii) Singular matrix. \hfill\ (4 marks)
